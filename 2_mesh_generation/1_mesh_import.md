...
`checkMesh` reveals one potential problem as the bounding box of the computational domain is $$64\,\text{m}$$ in $$x$$-direction, $$68.54\,\text{m}$$ in $$y$$-direction, and $$1.875\,\text{m}$$ in $$z$$-direction. This indicates that the mesh is incorrectly scaled.
